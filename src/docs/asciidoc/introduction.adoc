...
The developer will focus on his business code and ZetaPush will make his life easier by providing him with all the common bricks such as user management, data storage, etc.

In addition, ZetaPush hosts its business code and front-end code.
