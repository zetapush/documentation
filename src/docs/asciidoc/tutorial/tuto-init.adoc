...
So you already have the style and the frontend logic in the folder `assets` and `utils`. You can browse this files to understand this code.

In this tutorial, you need to :

. Create the business logic with a custom cloud service
. Implement interaction with the custom cloud service on the frontend
