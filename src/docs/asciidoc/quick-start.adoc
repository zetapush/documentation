...
// PREREQUISITES
include::{docdir}/common/prerequisites/prerequisites.adoc[leveloffset=+2]

== Create your first project

=== Create from your terminal
...
This starts a local web server to serve the web page on `localhost:3000` and also starts the custom cloud services.
You can open a web browser on `localhost:3000` and open the browser console.

Click on the button to see that the text of the button changes and the result of the call to the custom cloud service in the console.
...
This uploads your code (front and worker) to ZetaPush cloud. ZetaPush then handles the deployment
