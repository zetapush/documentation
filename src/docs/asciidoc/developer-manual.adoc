...
==== Expose a _custom cloud services_
...
Once you have developed your application and tested it, you may want to deploy it on ZetaPush cloud.
...
=== Deploy both front and _custom cloud services_ on ZetaPush Cloud
...
=== Deploy your _custom cloud services_ on ZetaPush Cloud
