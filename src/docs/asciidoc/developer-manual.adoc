...
// ADVANCED CONFIGURATION OF CLOUD SERVICES
== Advanced configuration of cloud services

=== Standard User Workflow
include::{docdir}/common/cloud-services/standard-user-workflow/advanced-configuration.adoc[leveloffset=+2]
...
// ADDING IMPLEMENTATION ON CLOUD SERVICES
== Adding own implementations on cloud services

=== Standard User Workflow
include::{docdir}/common/cloud-services/standard-user-workflow/adding-implementations.adoc[leveloffset=+2]