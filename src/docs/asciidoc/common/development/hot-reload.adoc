...
.worker/index.ts
[source,javascript,linenumbers, role="highlight-lines:8"]
----
import { Injectable } from '@zetapush/core';            
...
.front/index.js
[source, javascript, linenumbers, role="highlight-lines:18"]
----
// Create new ZetaPush Client
const client = new ZetaPushClient.WeakClient();
// Create a proxy to invoked worker methods
...
.front/index.js
[source, javascript, linenumbers, role="highlight-lines:8,19,21-25"]
----
// Create new ZetaPush Client
const client = new ZetaPushClient.WeakClient();
// Create a proxy to invoked worker methods
