...
First of all, if you want to include some services (custom or not), you need to use _dependency injection_ of ZetaPush. All of your dependency injection will be facilitated.

So, you need to import the package `@zetapush/platform` to import `Inject()`. This object will resolve the dependency injection of _cloud services_ and _custom cloud services_.
...
NOTE: The dependency injection of ZetaPush use Angular https://github.com/mgechev/injection-js[injection-js^] library.
